      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div>
            ...
            <ul className="space-y-2 mb-6">
              <li className="text-sm flex items-center">
                ...
                <a href="mailto:info@uade-commerce.com" className="hover:text-primary transition-colors">
                  info@uade-commerce.com
                </a>
              </li>
              <li className="text-sm flex items-center">
                <span className="mr-2">📱</span>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} UADE-Commerce. Todos los derechos reservados.
          </p>
          <p className="text-xs text-gray-600 mt-2">
            Desarrollado con ❤️ por estudiantes de UADE
          </p>
        </div>
      </div>
    </footer>
