...
import { Link, useNavigate } from "react-router-dom"; // Para navegación entre páginas
...
function ProductCard({ product, onAddToCart }) {
  ...
  const handleAddToCart = async () => {
    ...
    try {
      ...
      setMessage(err.message || "Error al agregar al carrito"); // Mostrar mensaje de error
