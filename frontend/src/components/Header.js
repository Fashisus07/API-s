          ...
          <nav className="flex items-center space-x-4">
            {isAuthenticated() ? (
              <>
                ...
                <Link to="/cart" className="text-white hover:text-accent-light transition">Mis compras</Link>
                <button 
      ...
      <div className="px-4 py-4 bg-white">
        <div className="max-w-7xl mx-auto flex items-center">
          ...
          <nav className="flex items-center space-x-6 ml-8">
            ...
            <Link to="/products" className="text-secondary hover:text-primary font-medium transition flex items-center">
              <span className="mr-1">📦</span> Productos
            </Link>
            
            {/* Carrito - visible para todos */}
            <Link to={isAuthenticated() ? "/cart" : "/login"} className="text-secondary hover:text-primary font-medium transition flex items-center relative">
      ...
      <div className="bg-gray-50 border-t border-gray-200 px-4 py-3">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center space-x-8 text-sm text-gray-600">
            ...
            <Link to="/products?category=electronicos" className="hover:text-primary transition">Electrónicos</Link>
            <Link to="/products?category=ropa" className="hover:text-primary transition">Ropa</Link>
            <Link to="/products?category=hogar" className="hover:text-primary transition">Hogar</Link>
            <Link to="/products?category=deportes" className="hover:text-primary transition">Deportes</Link>
            <Link to="/products?category=libros" className="hover:text-primary transition">Libros</Link>
            <Link to="/products" className="text-primary hover:text-primary-dark transition font-medium">Ver todas →</Link>
          </div>
        </div>
      </div>
    </header>
