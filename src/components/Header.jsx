      ...
      <div className="px-4 py-4 bg-white">
        <div className="max-w-7xl mx-auto flex items-center">
          ...
          <nav className="flex items-center space-x-6 ml-8">
            <Link to="/publicar-producto" className="text-secondary hover:text-primary font-medium transition flex items-center">
            ...
            {isAuthenticated() && (
              <Link to="/publicar-producto" className="bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary-dark font-medium transition shadow-md">
                Vender
              </Link>
            )}
          </nav>
